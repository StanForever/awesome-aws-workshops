...
site_description: (Unofficial) Curated list of Awesome AWS Workshops found around in the internet. Readily available for you to build on!
...
- [Build Chatbots with Amazon Bedrock Knowledge Bases and Agents](https://catalog.us-east-1.prod.workshops.aws/workshops/1e5b6626-f63c-41d7-adcb-4a3cdfd279ac/en-US)
- [Building Generative AI Applications on AWS](https://catalog.us-east-1.prod.workshops.aws/workshops/be7e9e99-69f1-4c65-882b-863580edaaea/en-US)
- [Threat Modeling a Q Business Application](https://catalog.us-east-1.prod.workshops.aws/workshops/8bd41408-82e1-4763-88e3-f0e75a34350a/en-US)
...
- [EKS Advanced Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/76a5dd80-3249-4101-8726-9be3eeee09b2/en-US)
...
- [Amazon EKS Terraform Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/afee4679-89af-408b-8108-44f5b1065cc7/en-US)
- [Amazon EKS Security Immersion Workshop](https://catalog.workshops.aws/eks-security-immersionday/en-US)
- [Building SaaS applications on Amazon EKS using GitOps](https://catalog.workshops.aws/eks-saas-gitops/en-US)
- [SaaS Factory Amazon EKS](https://catalog.us-east-1.prod.workshops.aws/workshops/e04c0885-830a-479b-844b-4c7af79697f8/en-US)
- [Application Modernization Blueprints Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/96f22c5f-744f-46a6-9a98-a8b65941f85f/en-US)
...
- [Istio on EKS](https://catalog.us-east-1.prod.workshops.aws/workshops/296c8da6-8474-4a7d-90c5-10090aa5e392/en-US)
...
- [Seamless Data Sharing Using Amazon Redshift](https://catalog.workshops.aws/seamless-data-sharing-using-amazon-redshift/en-US)
...
- [Chaos Engineering Workshop V2](https://catalog.us-east-1.prod.workshops.aws/workshops/eb89c4d5-7c9a-40e0-b0bc-1cde2df1cb97/en-US)
...
- [Terraform Developer Accelerator 🚀](https://catalog.workshops.aws/terraform-developer-accelerator/en-US)
- [Terraform expertise: Accelerate AWS deployments with modular IaC & AI](https://catalog.workshops.aws/tfqdev/en-US)
...
- [AWS Gateway Load Balancer](https://catalog.us-east-1.prod.workshops.aws/workshops/ae291640-10fe-4c0b-982f-9b9a61dbad26/en-US)
...
- [AWS Well-Architected Tool Workshop](https://catalog.workshops.aws/well-architected-tool/en-US)
...
- [Centralized Operations Management on AWS](https://catalog.workshops.aws/getting-started-with-com/en-US)
- [How to deploy Patch Policies outside of Quick Setup](https://catalog.us-east-1.prod.workshops.aws/workshops/7c0ea253-6462-41cd-af76-3850c92458fa/en-US)
- [Patching at Scale for Heterogenous Systems](https://catalog.workshops.aws/patching-at-scale/en-US)
...
- [AWS DataSync: Migrate Millions of Files](https://catalog.us-east-1.prod.workshops.aws/datasync-migrate-millions-of-files/en-US)
...
- [AWS Direct Connect + Hybrid DNS Workshop](https://catalog.workshops.aws/dxhybrid/en-US)
...
- [Threat Detection & Response Workshop](https://catalog.workshops.aws/security/en-US)
